...
function AdminContent() {
  ...
  const loadData = () => {
    ...
    const totalSeats = allServices.reduce((acc, service) => {
      return (
        acc +
        service.layout.flat().filter((seat) => seat === 1 || seat === 0).length
      );
    }, 0);
  ...
  const getOccupancyPercentage = (service: BusService) => {
    const totalSeats = service.layout
      .flat()
      .filter((seat) => seat === 1 || seat === 0).length;
    const occupiedSeats = service.layout
      .flat()
      .filter((seat) => seat === 1).length;
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
          <Card className="bg-linear-to-br from-blue-900/30 to-blue-800/20 border-blue-700/50 p-4 md:p-6">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
              <div>
                <p className="text-xs md:text-sm text-blue-300 mb-1">
                  Total Servicios
                </p>
          ...
          <Card className="bg-linear-to-br from-orange-900/30 to-orange-800/20 border-orange-700/50 p-4 md:p-6">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
              <div>
          ...
          <Card className="bg-linear-to-br from-green-900/30 to-green-800/20 border-green-700/50 p-4 md:p-6">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
              <div>
                <p className="text-xs md:text-sm text-green-300 mb-1">
                  Servicios Hoy
                </p>
                <p className="text-2xl md:text-3xl font-bold text-white">
                  {stats.todayServices}
          ...
          <Card className="bg-linear-to-br from-purple-900/30 to-purple-800/20 border-purple-700/50 p-4 md:p-6">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
              <div>
                      ...
                      >
                        ...
                        <td className="py-3 md:py-4 px-2 md:px-4">
                          <div className="flex items-center gap-2 min-w-[100px]">
                            ...
                            <span className="text-xs text-slate-400 w-8 md:w-12 whitespace-nowrap">
                              {occupancy}%
                            </span>
                          </div>
                        </td>
